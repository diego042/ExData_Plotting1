...
plot(dat2$tempo,as.numeric(paste(dat2$Global_active_power)), type="l",
     ylab="Global Active Power", xlab="")
plot(dat2$tempo,as.numeric(paste(dat2$Voltage)), type="l",
...
plot(dat2$tempo,as.numeric(paste(dat2$Global_reactive_power)), type="l",
     ylab="Global_rctive_power", xlab="datetime")
dev.off()
